    ...
    <div className="mt-5">
      <div className="flex items-start md:items-center justify-between gap-5 flex-col-reverse md:flex-row">
        <div className="md:w-1/2">
          ...
          <div className="grid mt-5 grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-2 md:mx-4">
        ...
        <div className="about relative z-[2] rounded-lg overflow-hidden border border-gray-30/50">
            <img src="public/about-bg.png" className="object-cover object-center md:w-[90%]" alt="about img" />
        </div>
      </div>
    </div>
  );
